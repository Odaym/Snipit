...
import com.ttco.bookmarker.showcaseview.targets.ActionViewTarget;
...
public class ShowcaseView extends RelativeLayout
    ...
    private final NewShowcaseDrawer showcaseDrawer;
    ...
    protected ShowcaseView(Context context, int innerRadius, int outerRadius) {
        this(context, null, R.styleable.CustomTheme_showcaseViewStyle, innerRadius, outerRadius);
    }

    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, int innerRadius, int outerRadius) {
        ...
        showcaseDrawer = new NewShowcaseDrawer(getResources(), innerRadius, outerRadius);
    ...
    private void init() {
        ...
        if (mEndButton.getParent() == null) {
            int margin = (int) getResources().getDimension(R.dimen.button_margin_left);
    ...
    /**
     * Builder class which allows easier creation of {@link com.bandindustries.roadie.ShowCase.ShowcaseView}s.
...
//        }
        ...
        public Builder(Activity activity, int innerRadius, int outerRadius) {
            this.activity = activity;
            this.showcaseView = new ShowcaseView(activity, innerRadius, outerRadius);
         ...
         */
        public Builder setActionTarget(ActionViewTarget target) {
