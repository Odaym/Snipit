...
import com.ttco.bookmarker.ocr.Client;
import com.ttco.bookmarker.ocr.ProcessingSettings;
import com.ttco.bookmarker.ocr.Task;

import java.io.FileOutputStream;

public class OCRImageAsyncTask extends AsyncTask<String, String, Boolean> {
    ...
    public OCRImageAsyncTask(ResultsActivity activity) {
