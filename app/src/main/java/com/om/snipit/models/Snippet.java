...
public class Snippet implements Parcelable {
  ...
  @DatabaseField int page_number;
  @DatabaseField String image_path;
  @DatabaseField String aws_image_path;
  @DatabaseField String ocr_content;
  @DatabaseField String date_added;
  @DatabaseField int order;
  @DatabaseField int views;
  @DatabaseField String note;
  @DatabaseField int isNoteShowing;
  @DatabaseField String screen_name;
