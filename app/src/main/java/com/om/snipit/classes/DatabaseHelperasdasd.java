...
public class DatabaseHelperasdasd extends SQLiteOpenHelper {
    public static final String databaseName = "snipit.db";
    ...
    public DatabaseHelperasdasd(Context context) {
