 ...
 * utilization is higher than you'd like, then you may want to consider reducing FPS.  If the
 * camera
...
@SuppressWarnings("deprecation") public class CameraSource {
  ...
  @SuppressLint("InlinedApi") private Camera createCamera() {
    ...
    try {
      ...
      Log.d(TAG, "Failed to open camera source. Being used by another application.");
    }
